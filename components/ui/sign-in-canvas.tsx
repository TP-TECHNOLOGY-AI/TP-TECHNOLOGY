...
export interface SignInCanvasProps {
...
const ShaderMaterialMesh = ({ source, uniforms }: { source: string; uniforms: Uniforms }) => {
  const { size } = useThree();
...
export const SignInCanvas: React.FC<SignInCanvasProps> = ({
  animationSpeed = 3,
