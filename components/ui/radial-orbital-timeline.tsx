  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-[#1a3a52] via-[#4a90a4] to-[#56CCF2] animate-pulse flex items-center justify-center z-10">
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle, rgba(74,144,164,0.3) 0%, rgba(74,144,164,0) 70%)`,
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-72 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        <div className="flex justify-between items-center text-xs mb-1">
                          <span className="flex items-center gap-1">
                            <Zap size={10} /> Fortschritt
                          </span>
                          <span className="font-mono">{item.energy}%</span>
                        </div>
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-[#1a3a52] to-[#4a90a4]"
                      ...
                      {item.relatedIds.length > 0 && (
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <div className="flex items-center mb-2">
                            ...
                            <h4 className="text-xs uppercase tracking-wider font-medium text-white/70">Verbundene Schritte</h4>
                          </div>
