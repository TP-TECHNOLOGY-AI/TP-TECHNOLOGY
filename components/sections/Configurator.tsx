...
import { ConfiguratorModal } from "@/components/ui/configurator-modal";

export default function Configurator() {
  const [modalOpen, setModalOpen] = useState(false);
  const [initialModule, setInitialModule] = useState<string | null>(null);

  const openModal = (module: string | null = null) => {
        ...
        <div className="py-24 px-6 section-glow">
          ...
          <div style={{
            ...
            <div style={{
              ...
              <button
                onClick={() => openModal("kern")}
                style={{ width: "100%", padding: "13px 24px", borderRadius: "100px", border: "1px solid rgba(255,255,255,0.2)", background: "transparent", color: "rgba(255,255,255,0.8)", fontSize: "14px", fontWeight: 600, cursor: "pointer", transition: "all 0.2s" }}
            ...
            <div style={{
              ...
              <button
                onClick={() => openModal("buchung")}
                style={{ width: "100%", padding: "13px 24px", borderRadius: "100px", border: "none", background: "#60a5fa", color: "#000", fontSize: "14px", fontWeight: 600, cursor: "pointer", transition: "opacity 0.2s" }}
